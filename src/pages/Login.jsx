            ...
            >
                ...
                <div className="glass-card rounded-[3rem] p-10 border-t border-white/5 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-3 group">
                            <label className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] ml-1 group-focus-within:text-brand transition-colors">Secret Key</label>
                            <div className="relative">
                    ...
                    <div className="mt-10 text-center border-t border-white/5 pt-10">
                        <p className="text-zinc-500 font-bold text-xs uppercase tracking-widest leading-loose">
                            New to the fleet? <br />
                            <Link to="/register" className="text-brand hover:text-white transition-colors">Establish Identity</Link>
                        </p>
                    </div>
                </div>

                <p className="text-center mt-12 text-[10px] text-zinc-800 font-black uppercase tracking-[0.4em]">Proprietary Scanning Logic</p>
            </motion.div>
        </div>
    );
};
